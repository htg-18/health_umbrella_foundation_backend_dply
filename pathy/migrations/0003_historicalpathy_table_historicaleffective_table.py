...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("pathy", "0002_alter_effective_table_show_alter_pathy_table_show"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="Historicaleffective_table",
            fields=[
                (
                    "id",
                    models.BigIntegerField(
            ...
            options={
                "verbose_name": "historical effective_table",
                "verbose_name_plural": "historical effective_tables",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
